    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_email.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                } else if (edit_email.getText().toString().trim().length() < 10) {
                    edit_email.setBackgroundResource(R.drawable.edittext_red);
                    email_warning.setVisibility(View.VISIBLE);
        ...
        edit_password1.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                if (edit_password1.getText().toString().trim().length() < 6) {
        ...
        edit_name.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                if (edit_name.getText().toString().trim().length() < 1) {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (imageUri == null) {
                                        ...
                                        if (gender.equals("남성")) {
                                            userModel.profileImageUrl = "https://firebasestorage.googleapis.com/v0/b/novel-52026.appspot.com/o/man.png?alt=media&token=3974938f-3db6-4486-9937-9cea73c31ffe";
                                        } else {
                                            userModel.profileImageUrl = "https://firebasestorage.googleapis.com/v0/b/novel-52026.appspot.com/o/woman.png?alt=media&token=ced70947-d4c3-4f61-9fe2-60af7d54f8eb";
                                        }
