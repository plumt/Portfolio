...
public class FinishNovelActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(FinishNovelActivity.this));
