...
public class CategoryActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_count = (TextView) findViewById(R.id.category_count);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CategoryActivty.this));
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerViewAdapter() {
            FirebaseDatabase.getInstance().getReference().child("novels").orderByChild("category_bool/" + category).equalTo(true).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            category_count.setText(String.valueOf(novels.size()));
