...
import com.e.note.alert.SendMailActivity;
import com.e.note.alert.SerchPasswordActivity;
import com.e.note.alert.SignupAlertActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(id.getText().toString()).matches() || id.getText().toString().trim().length() < 10) {
                    id.setBackgroundResource(R.drawable.edittext_red);
                    id_warning.setText("올바른 이메일을 입력해 주세요");
                    id_warning.setVisibility(View.VISIBLE);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                keyboardDown();
                Intent signup = new Intent(LoginActivity.this, SignupAlertActivity.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            id.setBackgroundResource(R.drawable.edittext_red);
                            id_warning.setText("아이디 및 비밀번호를 다시 확인해 주세요");
                            id_warning.setVisibility(View.VISIBLE);
                            password.setBackgroundResource(R.drawable.edittext_red);
