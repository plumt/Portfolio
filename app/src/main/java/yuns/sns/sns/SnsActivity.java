...
import yuns.sns.R;
import yuns.sns.sns.fragment.ChatFragment;
import yuns.sns.sns.fragment.PeopleFragment;
import yuns.sns.sns.fragment.ProfileFragment;

public class SnsActivity extends AppCompatActivity {
    private int finished = 0, history = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.sns_frame, new PeopleFragment()).commit();
        try {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.action_people:
                            if (history != 1) {
                                ...
                                fragmentTransaction.replace(R.id.sns_frame, new PeopleFragment()).commit();
                                finished = 0;
                                history = 1;
                            }
                            return true;
